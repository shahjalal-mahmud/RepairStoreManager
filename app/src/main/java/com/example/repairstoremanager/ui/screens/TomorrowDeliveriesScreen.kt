...
fun TomorrowDeliveriesScreen(
    ...
    val tomorrowsDeliveries = viewModel.tomorrowDeliveryList

    Scaffold(
        topBar = {
            TopAppBar(
                title = { Text("Tomorrow's Deliveries") },
                navigationIcon = {
            ...
            when {
                ...
                tomorrowsDeliveries.isEmpty() -> {
                    Column(
                        ...
                        Text(
                            text = "Plan ahead and stay on track 📅",
                    ...
                    Column(
                        ...
                        Text(
                            text = "Devices scheduled for tomorrow (${tomorrowsDeliveries.size})",
                            style = MaterialTheme.typography.titleMedium,
                            color = MaterialTheme.colorScheme.primary,
                        ...
                        LazyColumn(
                            ...
                            items(tomorrowsDeliveries, key = { it.id }) { customer: Customer ->
                                CustomerCard(
                                    customer = customer,
                                    viewModel = viewModel,
